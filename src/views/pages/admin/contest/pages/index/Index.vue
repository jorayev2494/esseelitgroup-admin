      ...
      <div class="card-body">
        ...
        <div class="mb-2">
          <router-link
            ...
            :to="$tMakeRoute({ name: 'contest-create' })"
          >
        ...
        >
          ...
          <template #actions="data">
            <router-link
              ...
              :to="$tMakeRoute({ name: 'contest-show', params: { uuid: data.value.uuid } })"
            >
            ...
            <router-link
              ...
              :to="$tMakeRoute({ name: 'contest-edit', params: { uuid: data.value.uuid } })"
            >
