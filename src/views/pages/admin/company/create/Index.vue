        ...
        <div class="card-body">
            <form action="#" method="POST" @submit.prevent="create" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" v-model="form.domain" class="form-control" required>
                    </div>
                </div>
    ...
    <div class="card flex-fill">
      ...
      <center>
        <div class="card-body mt-5">
          <div class="avatar avatar-xxl mt-5 mr-2">
            <img class="avatar-img rounded-circle" alt="User Image" :src="logoPreview">
          </div>
          <div class="avatar avatar-xxl mt-5 ml-2">
...
<script setup>
  ...
  const { form, logoPreview, uploadLogo, create } = useCreate();
</script>