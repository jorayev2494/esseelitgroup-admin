  ...
  <div class="col-sm-12">
    <div class="card">
      <div class="card-header">
        <h4 class="card-title">{{ $t('company.context_title') }}</h4>
        <p class="card-text">
      ...
      <div class="card-body">
        ...
        <div class="mb-2">
          <router-link
            ...
            :to="$tMakeRoute({ name: 'company-create' })"
          >
        ...
        >
          ...
          <template #actions="data">
            <!-- <router-link
              ...
              :to="$tMakeRoute({ name: 'company-show', params: { uuid: data.value.uuid } })"
            >
            ...
            <router-link
              ...
              :to="$tMakeRoute({ name: 'company-edit', params: { uuid: data.value.uuid } })"
            >
