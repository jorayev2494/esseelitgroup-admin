          ...
          <div class="row align-items-center">
            <div class="col">
              ...
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                  <router-link to="/admin/invoices">Invoice</router-link>
                </li>
              ...
              <div class="card-body">
                <div class="inovices-widget-header">
                  <span class="inovices-widget-icon">
                    <img src="@/assets/img/admin/icons/invoices-icon1.svg" alt="" />
                  </span>
          ...
          <div class="col-xl-3 col-sm-6 col-12">
            <div class="card inovices-card">
              <div class="card-body">
                <div class="inovices-widget-header">
                  <span class="inovices-widget-icon">
                    <img src="@/assets/img/admin/icons/invoices-icon2.svg" alt="" />
                  </span>
                  <div class="inovices-dash-count">
          ...
          <div class="col-xl-3 col-sm-6 col-12">
            <div class="card inovices-card">
              <div class="card-body">
                <div class="inovices-widget-header">
                  <span class="inovices-widget-icon">
                    <img src="@/assets/img/admin/icons/invoices-icon3.svg" alt="" />
                  </span>
                  <div class="inovices-dash-count">
          ...
          <div class="col-xl-3 col-sm-6 col-12">
            <div class="card inovices-card">
              <div class="card-body">
                <div class="inovices-widget-header">
                  <span class="inovices-widget-icon">
                    <img src="@/assets/img/admin/icons/invoices-icon4.svg" alt="" />
                  </span>
                  <div class="inovices-dash-count">
                  ...
                  <table class="table table-stripped table-hover datatable">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>14 Months</td>
                        <td>
                          <span class="badge bg-success-dark">Active</span>
                        </td>
                        <td class="text-end">
                          <router-link
                      ...
                      <tr>
                        ...
                        <td>12 Months</td>
                        <td>
                          <span class="badge bg-danger-dark">Expired</span>
                        </td>
                        <td class="text-end">
                          <router-link
                            to="/admin/edit-invoice"
