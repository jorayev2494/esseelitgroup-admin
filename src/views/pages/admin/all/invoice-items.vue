              ...
              <div class="row align-items-center">
                <div class="col-lg-12 col-md-12">
                  <div class="invoices-items-tabs">
                    <ul>
                      <li>
                        <router-link to="/admin/invoice-items" class="active"
                          >All Items</router-link
                        >
                      </li>
                      <li>
                        <router-link to="/admin/invoice-category"
