													...
													<tbody>
														<tr class="table-form-control add-row">
															...
															<td class="add-remove text-end">
																...
																<a href="#" class="copy-btn me-2"><i class="feather-copy"></i></a><a href="javascript:void(0);" class="remove-btn"><i class="feather-trash-2"></i></a>
															</td>
														</tr>
														<tr class="table-form-control add-row">
															<td>
										...
										<div class="card-body pb-0">
											...
											<div class="invoice-item invoice-item-bg">
												<div class="invoice-circle-img">
													<img src="@/assets/img/admin/invoice-circle1.png" alt="" class="invoice-circle1">
													<img src="@/assets/img/admin/invoice-circle2.png" alt="" class="invoice-circle2">
												</div>
												<div class="row">
												...
												<div class="row">
													...
													<div class="col-lg-4 col-md-4">
														<div class="invoice-sign text-end">
															<img class="img-fluid d-inline-block" src="@/assets/img/admin/signature.png" alt="sign">
					...
					<div class="modal-content">
						<div class="modal-body">
							...
							<div class="modal-btn delete-action">
								<div class="row">
									<div class="col-6">
										<a href="javascript:void(0);" data-bs-dismiss="modal" class="btn w-100 btn-primary paid-continue-btn">Delete</a>
									</div>
									<div class="col-6">
					...
					<div class="modal-content">
						<div class="modal-body">
							...
							<div class="modal-btn delete-action">
								<div class="row">
									<div class="col-6">
										<a href="javascript:void(0);" data-bs-dismiss="modal" class="btn btn-primary paid-continue-btn w-100">Delete</a>
									</div>
									<div class="col-6">
										<a href="javascript:void(0);" data-bs-dismiss="modal" class="btn btn-primary paid-cancel-btn w-100">Cancel</a>
									</div>
					...
					<div class="modal-content">
						<div class="modal-body">
							...
							<div class="modal-btn delete-action">
								<div class="row">
									<div class="col-6">
										<a href="javascript:void(0);" data-bs-dismiss="modal" class="btn btn-primary paid-continue-btn w-100">Save</a>
									</div>
									<div class="col-6">
										<a href="javascript:void(0);" data-bs-dismiss="modal" class="btn btn-primary paid-cancel-btn w-100">Cancel</a>
									</div>
