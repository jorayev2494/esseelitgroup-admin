  ...
  <div class="col-sm-12">
    <div class="card">
      <div class="card-header">
        <h4 class="card-title">{{ $t('country.context_title') }}</h4>
        <!-- <p class="card-text">
      ...
      <div class="card-body">
        ...
        <div class="mb-2">
          <router-link
            ...
            :to="$tMakeRoute({ name: 'country-create' })"
          >
        ...
        >
          ...
          <template #actions="data">
            <!-- <router-link
              ...
              :to="$tMakeRoute({ name: 'country-show', params: { uuid: data.value.uuid } })"
            >
            ...
            <router-link
              ...
              :to="$tMakeRoute({ name: 'country-edit', params: { uuid: data.value.uuid } })"
            >
