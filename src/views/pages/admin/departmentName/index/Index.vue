  ...
  <div class="col-sm-12">
    <div class="card">
      ...
      <div class="card-body">
        ...
        <div class="mb-2">
          <router-link class="btn btn-primary btn-sm me-2" :to="$tMakeRoute({ name: 'department-name-create' })">
        ...
        >
          <template #actions="data">
            ...
            <router-link class="btn btn-sm bg-success-light me-2" :to="$tMakeRoute({ name: 'department-name-edit', params: { uuid: data.value.uuid } })">
