          ...
          <div class="form-group row" v-for="(value, name) of form.translations[locale]" :key="name">
            ...
            <div class="col-lg-9">
              <div v-if="inputs[name]['type'] == 'text'">
                <input type="text" class="form-control" v-model="form.translations[locale][name]" :key="name + 2">
              </div>
              <div v-if="inputs[name]['type'] == 'textarea'">
                <textarea class="form-control" v-model="form.translations[locale][name]" :key="name + 2" rows="5" style="height: 100%;"></textarea>
              </div>
            </div>
          </div>
        </div>
